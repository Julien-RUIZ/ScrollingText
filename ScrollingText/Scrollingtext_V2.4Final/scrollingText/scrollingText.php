...
class ScrollingText extends Module
{
    ...
    {
        $value = [
        ['id_scrollingText'=>'0', 'name' => 'HookHeader', 'value' => tools::getValue('HookHeader')],
        ['id_scrollingText'=>'1', 'name' => 'HookHome', 'value' => tools::getValue('HookHome')],
        ['id_scrollingText'=>'2', 'name' => 'HookFooter', 'value' => tools::getValue('HookFooter')],
        ['id_scrollingText'=>'3', 'name' => 'HookPanier', 'value' => tools::getValue('HookPanier')],
        ['id_scrollingText'=>'4', 'name' => 'HookProduct', 'value' => tools::getValue('HookProduct')],
        ['id_scrollingText'=>'5', 'name' => 'ChoiceText', 'value' => tools::getValue('ChoiceText')],
        ['id_scrollingText'=>'6', 'name' => 'FontSize', 'value' => tools::getValue('FontSize')],
        ['id_scrollingText'=>'7', 'name' => 'Padding', 'value' => tools::getValue('Padding')],
        ['id_scrollingText'=>'8', 'name' => 'TextBold', 'value' => tools::getValue('TextBold')],
        ['id_scrollingText'=>'9', 'name' => 'TextItalic', 'value' => tools::getValue('TextItalic')],
        ['id_scrollingText'=>'10', 'name' => 'TextColor', 'value' => tools::getValue('TextColor')],
        ['id_scrollingText'=>'11', 'name' => 'ChoiceColor', 'value' => tools::getValue('ChoiceColor')],
        ['id_scrollingText'=>'12', 'name' => 'ChoiceSpeed', 'value' => tools::getValue('ChoiceSpeed')],
        ['id_scrollingText'=>'13', 'name' => 'ChoiceSens', 'value' => tools::getValue('ChoiceSens')],
